// TODO: fancy-settings should be reworked from scratch, along with setting.js and other dependencies, exclude mootools
(function () {
    ...
    FancySettings.__proto__.initWithManifest = function (callback) {
		...
		storedSettings.get(Object.keys(settings.manifest), function(storedItems){
			"use strict";

			for (var item in storedItems){
				settings.manifest[item].set(storedItems[item]);
			}
		});
